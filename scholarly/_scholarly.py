...
from .data_types import (Author, AuthorSource, CitesPerYear, Journal,
...
class _Scholarly:
    ...
    def search_pubs_by_id(self, author_id, publication_limit=10):
        publications = []
        pubstart = 0
        url_citations = _CITATIONAUTH.format(author_id)
        url_citations += "&view_op=list_works&sortby=pubdate"
